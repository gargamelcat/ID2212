...
public class DBDriver {
                ...
                if (!exist) {
                        ...
                        statement
                                        .executeUpdate("CREATE TABLE IF NOT EXISTS"
                                                        ...
                                                        + "FOREIGN KEY (fkw_itemID) REFERENCES Items(name),"
                        ...
                        statement
                                        .executeUpdate("CREATE TABLE IF NOT EXISTS"
                                                        ...
                                                        + "FOREIGN KEY (fks_itemID) REFERENCES Items(name),"
        ...
        private void prepareStatements() throws SQLException {
                ...
                deleteWishStatement = connection.prepareStatement("DELETE FROM "
                                + TABLE_WISHES + " WHERE fkw_name = ?");
 
                findWishStatement = connection.prepareStatement("SELECT fkw_name from "
                                + TABLE_WISHES + " WHERE fkw_name = ? AND fkw_itemID = ?");
        ...
        public boolean checkIfWishExists(String name, String item) {
                ...
                try {
                        ...
                        System.out.println("You already have this item on the wish list: " + item);
                        e.printStackTrace();
                }
                return wishExists;
        }
